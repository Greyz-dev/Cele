...
!function() {
    ...
    e.prototype.stop = function() {
        return this.handle && (i(this.handle),
        this.handle = null),
        this
    }
    ,
...
+function(n) {
    ...
    n(function() {
        ...
        n.support.transition) && (n.event.special.ggTransitionEnd = {
...
+function(n) {
    ...
    function r(i) {
        return this.each(function() {
            var u = n(this)
              , r = u.data("gg.tooltip")
              , f = typeof i == "object" && i;
            (r || i != "destroy") && (r || u.data("gg.tooltip", r = new t(this,f)),
            typeof i == "string" && r[i]())
        })
    }
    var t = function(n, t) {
    ...
    t.prototype.show = function() {
        var c = n.Event("show.gg." + this.type), l, p, h;
    ...
    t.prototype.replaceArrow = function(n, t, i) {
        n > 0 && (this.arrow().css(i ? "left" : "top", 50 * (1 - n / t) + "%").css(i ? "top" : "left", ""),
        this.arrowShadow().css(i ? "left" : "top", 50 * (1 - n / t) + "%").css(i ? "top" : "left", ""))
    }
    ;
    ...
    t.prototype.hide = function(i) {
        ...
        !f.isDefaultPrevented())
            ...
            n.support.transition && this.$tip.hasClass("fade") ? u.one("ggTransitionEnd", e).emulateTransitionEnd(t.TRANSITION_DURATION) : e(),
    ...
    t.prototype.toggle = function(t) {
        var i = this;
        t && (i = n(t.currentTarget).data("gg." + this.type),
...
+function(n) {
    ...
    function r(i) {
        return this.each(function() {
            var u = n(this)
              , r = u.data("gg.popover")
              , f = typeof i == "object" && i;
            (r || i != "destroy") && (r || u.data("gg.popover", r = new t(this,f)),
            typeof i == "string" && r[i]())
        })
    }
    var t = function(n, t) {
    ...
    if (!n.fn.ggtooltip)
        throw new Error("ggPopover requires ggtooltip.js");
    t.VERSION = "1.0";
...
!function($) {
    ...
    $.fn.ggtooltip = function(option) {
        return this.each(function() {
            ...
            if (!data)
                $this.data('ggtooltip', (data = new ggTooltip(this,options)))
...
!function(e) {
    e.fn.gMap = function(o, a) {
        ...
        return this.each(function() {
            ...
            }) : o.setCenter(new google.maps.LatLng(n.markers[0].latitude,n.markers[0].longitude)) : o.setCenter(new google.maps.LatLng(34.885931,9.84375)),
            o.setZoom(n.zoom),
            ...
            t.anchor = new google.maps.Point(n.icon.iconanchor[0],n.icon.iconanchor[1]),
            i.setIcon(t),
            n.icon.shadow && (r = new google.maps.MarkerImage(n.icon.shadow),
            r.size = new google.maps.Size(n.icon.shadowsize[0],n.icon.shadowsize[1]),
            r.anchor = new google.maps.Point(n.icon.shadowanchor[0],n.icon.shadowanchor[1]),
            i.setShadow(r)),
            ...
            e(this).bind("gMap.addMarker", function(e, a, s, t, r, d) {
                var c, p, m = new google.maps.LatLng(parseFloat(a),parseFloat(s)), h = new google.maps.Marker({
                    position: m
                });
                if (r ? (c = new google.maps.MarkerImage(r.image),
                c.size = new google.maps.Size(r.iconsize[0],r.iconsize[1]),
                c.anchor = new google.maps.Point(r.iconanchor[0],r.iconanchor[1]),
                h.setIcon(c),
                r.shadow && (p = new google.maps.MarkerImage(r.shadow),
                p.size = new google.maps.Size(r.shadowsize[0],r.shadowsize[1]),
                p.anchor = new google.maps.Point(r.shadowanchor[0],r.shadowanchor[1]),
                i.setShadow(p))) : (h.setIcon(i.getIcon()),
                h.setShadow(i.getShadow())),
                t) {
                    "_latlng" === t && (t = a + ", " + s);
            ...
            for (var d, c = this, p = function(o) {
                ...
                d = n.markers[m],
                d.address ? ("_address" === d.html && (d.html = d.address),
                a.geocode({
                    address: d.address
